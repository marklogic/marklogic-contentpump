...
java -DCONTENTPUMP_HOME="%LIB_HOME%" -DBUNDLE_ARTIFACT="%BUNDLE_ARTIFACT%" -Dfile.encoding="UTF-8" -Djavax.security.auth.useSubjectCredsOnly=false -Dxcc.txn.compatible=true %JVM_OPTS% com.marklogic.contentpump.ContentPump %*
