/*
 * Copyright (c) 2011-2011 Progress Software Corporation and/or its subsidiaries or affiliates. All Rights Reserved.
 *
...
/**
 * Wrapper class for the <code>cts:element-value-match</code> lexicon
 ...
 * @author jchen
 */
public abstract class ElementValueMatch extends ValueOrWordMatchFunction {
    ...
    void appendFunctionName(StringBuilder buf) {
        buf.append("cts:element-value-match");
    }
