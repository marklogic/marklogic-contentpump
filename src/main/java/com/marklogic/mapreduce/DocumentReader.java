/*
 * Copyright (c) 2011-2019 Progress Software Corporation and/or its subsidiaries or affiliates. All Rights Reserved.
...
extends MarkLogicRecordReader<DocumentURI, VALUEIN> {
    ...
    public DocumentReader(Configuration conf) {
        super(conf);
        valueClass = conf.getClass(INPUT_VALUE_CLASS, DatabaseDocument.class, 
                Writable.class);
    }
