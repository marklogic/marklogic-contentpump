...
mvn install:install-file -DgroupId=com.marklogic -DartifactId=marklogic-mapreduce1 -Dversion=2.1 -Dfile=../mapreduce/buildtmp/java/marklogic-mapreduce1-2.1.${DATE}.jar -Dpackaging=jar
