...
/**
 * Reader for RDF triples. Uses Jena library to parse RDF and sends triples
 ...
 * @param <VALUEIN>
 */
public class TriplesReader<VALUEIN> extends RDFReader<VALUEIN> {
    protected PipedRDFIterator<Triple> rdfIter;
    protected PipedRDFStream<Triple> rdfInputStream;
    protected ExecutorService executor;

    public TriplesReader() {
        super();
    }
