...
/**
 * MarkLogicRecordWriter that inserts documents to MarkLogic Server.
 * 
 * @author jchen
 */
public class DocumentWriter extends MarkLogicRecordWriter<DocumentURI> {
	public static final Log LOG = LogFactory.getLog(DocumentWriter.class);
	/**
	...
	public DocumentWriter(URI serverUri, String outputDir,
			String[] collections, String[] perms, String quality) {
		super(serverUri);
	...
	throws IOException, InterruptedException {
		...
		try {
		    ...
		    Content content = ContentFactory.newContent(uri, 
		    		value.getNode(), options);
