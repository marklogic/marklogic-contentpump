...
public class AuditUtil {
    ...
    public static void prepareAuditMlcpFinish(Configuration conf, int ruleCount) {
        ...
        conf.set(MarkLogicConstants.AUDIT_MLCPFINISH_MESSAGE, buf.toString());
    }
    ...
    public static void auditMlcpFinish(Configuration conf, String jobName, 
        ...
        if (!conf.getBoolean(MarkLogicConstants.AUDIT_MLCPFINISH_ENABLED, false)) {
            return;
        }
        ...
        String ruleCounter = conf.get(MarkLogicConstants.AUDIT_MLCPFINISH_MESSAGE);
        if (ruleCounter != null) {
            auditBuf.append("; ");
    ...
    public static void auditMlcpStart(Configuration conf, String jobName) 
            throws IOException {
        String mlcpStartMessage = conf.get(MarkLogicConstants.AUDIT_MLCPSTART_MESSAGE);
        StringBuilder auditBuf = new StringBuilder();
        auditBuf.append("job=");
        auditBuf.append(jobName);
        auditBuf.append("; ");
